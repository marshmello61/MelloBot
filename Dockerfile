...
#Import Gudz
RUN wget https://raw.githubusercontent.com/marshmello61/MelloBot/fire/mellobotmain.py
RUN wget https://raw.githubusercontent.com/marshmello61/MelloBot/fire/requirements.txt
#Start Fumkin
RUN pip3 install -r requirements.txt

CMD ["python3","mellobotmain.py"]
