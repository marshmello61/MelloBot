...
async def git_commit(file_name, mone):
    ...
    for i in content_list:
        ...
        if i == 'ContentFile(path="' + file_name + '")':
            ...
            create_file = False
    file_name = "mwllobot/modules/" + file_name
    if create_file == True:
        file_name = file_name.replace("./mellobot/temp/", "")
        print(file_name)
        try:
            repo.create_file(
            ...
            ccess = ccess.strip()
            await mone.edit(
                f"`Commited On Your Github Repo`\n\n[Your STDPLUGINS](https://github.com/{ccess}/tree/master/mellobot/modules/)"
            )
        except:
