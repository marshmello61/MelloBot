...
@catub.cat_cmd(
    ...
    info={
        ...
        "examples": "{tr}fakegs MelloBot ; One of the Popular userbot",
    },
)
...
@catub.cat_cmd(
    ...
    info={
        ...
        "usage": "{tr}trump <text>",
        "examples": "{tr}trump MelloBot is One of the Popular userbot",
    },
)
async def nekobot(cat):
...
@catub.cat_cmd(
    ...
    info={
        ...
        "usage": "{tr}modi <text>",
        "examples": "{tr}modi MelloBot is One of the Popular userbot",
    },
)
async def nekobot(cat):
...
@catub.cat_cmd(
    ...
    info={
        ...
        "usage": "{tr}cmm <text>",
        "examples": "{tr}cmm MelloBot is One of the Popular userbot",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@catub.cat_cmd(
    ...
    info={
        ...
        "usage": "{tr}kanna text",
        "examples": "{tr}kanna MelloBot is One of the Popular userbot",
    },
)
async def nekobot(cat):
...
@catub.cat_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; MelloBot is One of the Popular userbot",
    },
)
async def nekobot(cat):
