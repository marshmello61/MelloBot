...
@catub.cat_cmd(
    ...
    info={
        ...
        "examples": "{tr}smallcaps MelloBot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
...
@catub.cat_cmd(
    ...
    info={
        ...
        "examples": "{tr}smothtext MelloBot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
