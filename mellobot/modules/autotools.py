...
DEFAULTUSER = str(AUTONAME) if AUTONAME else "MelloBot"
...
async def autopic(event):
    if event.fwd_from:
        return
    global AUTOPICSTART
    downloaded_file_name = "mellobot/original_pic.png"
    downloader = SmartDL(
        Var.DOWNLOAD_PFP_URL_CLOCK, downloaded_file_name, progress_bar=False
    )
    downloader.start(blocking=False)
    photo = "mellobot/photo_pfp.png"
