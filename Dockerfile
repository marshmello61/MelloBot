...
#Import Gudz
RUN wget https://raw.githubusercontent.com/marshmello61/mellobot/light/lightningrun.py
RUN wget https://raw.githubusercontent.com/marshmello61/mellobot/light/requirements.txt
#Start Fumkin
