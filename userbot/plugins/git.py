...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/marshmello61/MelloBot) to open this bot source code\
        \nClick [here](https://github.com/marshmello61/mellobot/tree/mellodeploy) to open supported link for heroku",
    )
...
@catub.cat_cmd(
    ...
    info={
        ...
        "examples": [".github marshmello61", ".github -l5 marshmello61"],
    },
)
async def _(event):
