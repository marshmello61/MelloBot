...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_file(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("Deploy your MelloBot", data="deploy")],
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            event.chat_id,
            message="You Can Deploy MelloBot In Heroku By Following Steps Bellow, You Can See Some Quick Guides On Support Channel Or On Your Own Assistant Bot. \nThank You For Contacting Me.",
            link_preview=False,
            buttons=[
                [custom.Button.inline("Deploy your MelloBot", data="deploy")],
                [Button.url("Help Me ❓", "https://t.me/MelloLab")],
                [Button.url("Github Repo ❓", "github.com/marshmello61/MelloBot")],
            ],
        )
